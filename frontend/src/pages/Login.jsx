...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6F3] p-4 lg:p-6">
      <main className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-[1240px] overflow-hidden bg-white shadow-xl shadow-[#0B6B3A]/10 lg:min-h-[720px] lg:grid-cols-2 lg:rounded-xl">
        <AuthSide />
